...
import 'package:secure/inlyfe/screens/home_screen/home_screen.dart';
import 'package:secure/inlyfe/screens/service_requests/service_order.dart';
import 'package:secure/inlyfe/screens/services/widgets/service_screen.dart';
import 'package:secure/features/personalization/screens/settings/settings_screen.dart';
      ...
      bottomNavigationBar: Obx(
        () => NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(icon: Icon(Iconsax.activity5), label: 'Activites'),
...
class NavigationController extends GetxController {
  ...
  final screens = [
    HomeScreen(), 
    const ServiceScreen(), MyRequestsScreen(), const SettingsScreen()];
