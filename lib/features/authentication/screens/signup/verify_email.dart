...
import 'package:secure/features/authentication/screens/login/login_screen.dart';
import 'package:secure/features/authentication/screens/login/phone_login.dart';
import 'package:secure/features/authentication/screens/password_configuration/success_screen.dart';
...
class VerifyEmailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: SeAppBar(actions: [IconButton(onPressed: ()=> Get.offAll(() =>  PhoneLoginScreen()), icon: Icon(CupertinoIcons.clear))],),
