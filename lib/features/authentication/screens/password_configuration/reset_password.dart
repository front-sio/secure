        ...
        child: Padding(
          ...
          child: Column(
           ...
           const SizedBox(height: SecuriteSize.spaceBtwSection,),
            ...
            Text("Your account security is our priority! we've sent you a secure link to safety change your password and keep your account protected.".capitalize!, style: Theme.of(context).textTheme.labelMedium, textAlign: TextAlign.center,),
            const SizedBox(height: SecuriteSize.spaceBtwSection,),
